...
const newsPostsJa: NewsPost[] = [
  {
    ...
    summary:
      "機能、使い方、ウィジェット、Share Pass、FAQ、プライバシーポリシー、利用規約をまとめて掲載しています。",
    body: [
      ...
      "Remeetは独自アカウント不要です。最初の再会は無料で共有でき、2回目以降はShare Passを使って1人のパートナーとiCloud共有できます。詳細はShare Pass・プライバシーポリシー・利用規約のページをご確認ください。",
    ],
  },
];
...
const newsPostsEn: NewsPost[] = [
  {
    ...
    summary: "Features, how-to, widgets, Share Pass, FAQ, Privacy Policy, and Terms—in one place.",
    body: [
      ...
      "Remeet needs no proprietary account. Share your first reunion for free, then use a Share Pass for each additional reunion shared with one partner through iCloud. See the Share Pass, Privacy, and Terms pages for details.",
    ],
  },
];
